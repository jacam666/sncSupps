        ...
        <div className="bg-gradient-to-br from-gray-50 to-orange-50 min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-28 pb-4">
                <nav className="text-sm text-gray-600">
                    ...
                    <Link href="/fatLoss" className="hover:text-orange-600 transition-colors">
                        Fat Loss Products
                    </Link>
                    <span className="mx-2">›</span>
            ...
            <div className="max-w-7xl mx-auto px-6 mb-12">
                <div className="text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
                        Premium fat loss supplement designed for optimal results
                    </p>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-orange-100 p-8">
                            <div className="space-y-6">
                                ...
                                <div className="text-center pb-6 border-b border-gray-200">
                                    ...
                                    <div className="text-gray-600">Premium Quality Supplement</div>
                                </div>
